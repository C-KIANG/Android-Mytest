...
import static com.edu.hzuapps.androidlabs.mytoolbox.Module.Function.Notepad.NotepadActivity.TAG_INSERT;
import static com.edu.hzuapps.androidlabs.mytoolbox.Module.Function.Notepad.NotepadActivity.TAG_UPDATE;
import static com.edu.hzuapps.androidlabs.mytoolbox.Module.Function.Notepad.NotepadActivity.dbHelper;
import static com.edu.hzuapps.androidlabs.mytoolbox.Module.Function.Notepad.NotepadActivity.getDbHelper;
        ...
        switch(item.getItemId()){
            case R.id.save:
                if(tag==TAG_INSERT) {
                    ...
                    db.update(DatabaseHelper.TABLE_NAME,values,"id=?",new String[]{String.valueOf(id)});
                    finish();
                    break;
                }
            case R.id.delete:
